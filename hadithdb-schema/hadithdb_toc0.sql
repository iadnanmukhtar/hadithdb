...
CREATE TABLE `toc` (
  ...
  KEY `ndx_h1` (`id`,`bookId`,`level`,`h1`),
  KEY `ndx_start0` (`start0`),
  KEY `ndx_toc1` (`bookId`,`level`,`h1`,`id`),
  KEY `ndx_toc2` (`bookId`,`level`,`h2`,`id`),
  KEY `ndx_toc3` (`bookId`,`level`,`h3`,`id`),
  KEY `ndx_h123` (`bookId`,`level`,`h1`,`h2`,`h3`,`id`),
  KEY `ndx_h12` (`bookId`,`level`,`h1`,`h2`,`id`),
  KEY `ndx_toc4` (`bookId`,`level`,`h3`,`h2`,`h1`,`id`),
  KEY `ndx_ordinal` (`ordinal`),
  KEY `ndx_bk_orda` (`bookId`,`ordinal`),
  KEY `ndx_bk_ordd` (`bookId` DESC,`ordinal` DESC),
...
-- Dump completed on 2023-07-30  0:33:41
