...
--
-- Temporary view structure for view `v_hadiths_virtual2`
--

DROP TABLE IF EXISTS `v_hadiths_virtual2`;
/*!50001 DROP VIEW IF EXISTS `v_hadiths_virtual2`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_hadiths_virtual2` AS SELECT 
 1 AS `id`,
 1 AS `hId`,
 1 AS `hId_ref`,
 1 AS `doctype`,
 ...
 1 AS `num0`,
 1 AS `book_alias_ref`,
 1 AS `book_shortName_en_ref`,
 1 AS `book_shortName_ref`,
 1 AS `book_name_en_ref`,
 1 AS `book_name_ref`,
 1 AS `book_author_ref`,
 1 AS `level_ref`,
 1 AS `path_ref`,
 1 AS `h1_id_ref`,
 1 AS `h1_ref`,
 1 AS `h1_title_en_ref`,
 1 AS `h1_title_ref`,
 1 AS `h1_intro_en_ref`,
 1 AS `h1_intro_ref`,
 1 AS `h1_start_ref`,
 1 AS `h1_count_ref`,
 1 AS `h2_id_ref`,
 1 AS `h2_ref`,
 1 AS `h2_title_en_ref`,
 1 AS `h2_title_ref`,
 1 AS `h2_intro_en_ref`,
 1 AS `h2_intro_ref`,
 1 AS `h2_start_ref`,
 1 AS `h2_count_ref`,
 1 AS `h3_id_ref`,
 1 AS `h3_ref`,
 1 AS `h3_title_en_ref`,
 1 AS `h3_title_ref`,
 1 AS `h3_intro_en_ref`,
 1 AS `h3_intro_ref`,
 1 AS `h3_start_ref`,
 1 AS `h3_count_ref`,
 1 AS `ordinal_ref`,
 1 AS `numInChapter_ref`,
 1 AS `grade_id`,
 1 AS `grade_grade_en`,
 1 AS `grade_grade`,
 1 AS `grader_id`,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`adnanmukhtar`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_hadiths_virtual2` AS select `hv`.`id` AS `id`,`hv`.`id` AS `hId`,`h`.`hId` AS `hId_ref`,'hadith' AS `doctype`,`t`.`path` AS `path`,`h`.`ref` AS `ref_ref`,`t`.`book_id` AS `book_id`,`t`.`book_alias` AS `book_alias`,`t`.`book_shortName_en` AS `book_shortName_en`,`t`.`book_shortName` AS `book_shortName`,`t`.`book_name_en` AS `book_name_en`,`t`.`book_name` AS `book_name`,`t`.`book_author` AS `book_author`,`t`.`book_virtual` AS `book_virtual`,`t`.`level` AS `level`,`t`.`h1_id` AS `h1_id`,`t`.`h1` AS `h1`,`t`.`h1_title_en` AS `h1_title_en`,`t`.`h1_title` AS `h1_title`,`t`.`h1_intro_en` AS `h1_intro_en`,`t`.`h1_intro` AS `h1_intro`,`t`.`h1_start` AS `h1_start`,`t`.`h1_count` AS `h1_count`,`t`.`h2_id` AS `h2_id`,`t`.`h2` AS `h2`,`t`.`h2_title_en` AS `h2_title_en`,`t`.`h2_title` AS `h2_title`,`t`.`h2_intro_en` AS `h2_intro_en`,`t`.`h2_intro` AS `h2_intro`,`t`.`h2_start` AS `h2_start`,`t`.`h2_count` AS `h2_count`,`t`.`h3_id` AS `h3_id`,`t`.`h3` AS `h3`,`t`.`h3_title_en` AS `h3_title_en`,`t`.`h3_title` AS `h3_title`,`t`.`h3_intro_en` AS `h3_intro_en`,`t`.`h3_intro` AS `h3_intro`,`t`.`h3_start` AS `h3_start`,`t`.`h3_count` AS `h3_count`,`hv`.`ordinal` AS `ordinal`,`hv`.`numInChapter` AS `numInChapter`,`hv`.`num` AS `num`,`hv`.`num0` AS `num0`,`h`.`book_alias` AS `book_alias_ref`,`h`.`book_shortName_en` AS `book_shortName_en_ref`,`h`.`book_shortName` AS `book_shortName_ref`,`h`.`book_name_en` AS `book_name_en_ref`,`h`.`book_name` AS `book_name_ref`,`h`.`book_author` AS `book_author_ref`,`h`.`level` AS `level_ref`,`h`.`path` AS `path_ref`,`h`.`h1_id` AS `h1_id_ref`,`h`.`h1` AS `h1_ref`,`h`.`h1_title_en` AS `h1_title_en_ref`,`h`.`h1_title` AS `h1_title_ref`,`h`.`h1_intro_en` AS `h1_intro_en_ref`,`h`.`h1_intro` AS `h1_intro_ref`,`h`.`h1_start` AS `h1_start_ref`,`h`.`h1_count` AS `h1_count_ref`,`h`.`h2_id` AS `h2_id_ref`,`h`.`h2` AS `h2_ref`,`h`.`h2_title_en` AS `h2_title_en_ref`,`h`.`h2_title` AS `h2_title_ref`,`h`.`h2_intro_en` AS `h2_intro_en_ref`,`h`.`h2_intro` AS `h2_intro_ref`,`h`.`h2_start` AS `h2_start_ref`,`h`.`h2_count` AS `h2_count_ref`,`h`.`h3_id` AS `h3_id_ref`,`h`.`h3` AS `h3_ref`,`h`.`h3_title_en` AS `h3_title_en_ref`,`h`.`h3_title` AS `h3_title_ref`,`h`.`h3_intro_en` AS `h3_intro_en_ref`,`h`.`h3_intro` AS `h3_intro_ref`,`h`.`h3_start` AS `h3_start_ref`,`h`.`h3_count` AS `h3_count_ref`,`h`.`ordinal` AS `ordinal_ref`,`h`.`numInChapter` AS `numInChapter_ref`,`h`.`grade_id` AS `grade_id`,`h`.`grade_grade_en` AS `grade_grade_en`,`h`.`grade_grade` AS `grade_grade`,`h`.`grader_id` AS `grader_id`,`h`.`grader_shortName_en` AS `grader_shortName_en`,`h`.`grader_shortName` AS `grader_shortName`,`h`.`grader_name_en` AS `grader_name_en`,`h`.`grader_name` AS `grader_name`,`h`.`verified` AS `verified`,`h`.`remark` AS `remark`,`h`.`numActual` AS `numActual`,`h`.`num` AS `num_ref`,`h`.`num0` AS `num0_ref`,`h`.`title_en` AS `title_en`,`h`.`title` AS `title`,`h`.`part_en` AS `part_en`,`h`.`part` AS `part`,`h`.`chain_en` AS `chain_en`,`h`.`body_en` AS `body_en`,`h`.`footnote_en` AS `footnote_en`,`h`.`chain` AS `chain`,`h`.`body` AS `body`,`h`.`footnote` AS `footnote`,`h`.`tags` AS `tags`,`h`.`lastmod` AS `lastmod`,`h`.`highlight` AS `highlight` from ((`hadiths_virtual` `hv` join `v_hadiths` `h`) join `v_toc` `t`) where ((`hv`.`hadithId` = `h`.`hId`) and (`hv`.`tocId` = `t`.`hId`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`adnanmukhtar`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `v_hadiths` AS select `h`.`id` AS `id`,`h`.`id` AS `hId`,'hadith' AS `doctype`,`t`.`path` AS `path`,concat(`t`.`book_alias`,':',`h`.`num`) AS `ref`,`t`.`book_id` AS `book_id`,`t`.`book_alias` AS `book_alias`,`t`.`book_shortName_en` AS `book_shortName_en`,`t`.`book_shortName` AS `book_shortName`,`t`.`book_name_en` AS `book_name_en`,`t`.`book_name` AS `book_name`,`t`.`book_author` AS `book_author`,`t`.`book_virtual` AS `book_virtual`,`t`.`level` AS `level`,`t`.`h1_id` AS `h1_id`,`t`.`h1` AS `h1`,`t`.`h1_title_en` AS `h1_title_en`,`t`.`h1_title` AS `h1_title`,`t`.`h1_intro_en` AS `h1_intro_en`,`t`.`h1_intro` AS `h1_intro`,`t`.`h1_start` AS `h1_start`,`t`.`h1_count` AS `h1_count`,`t`.`h2_id` AS `h2_id`,`t`.`h2` AS `h2`,`t`.`h2_title_en` AS `h2_title_en`,`t`.`h2_title` AS `h2_title`,`t`.`h2_intro_en` AS `h2_intro_en`,`t`.`h2_intro` AS `h2_intro`,`t`.`h2_start` AS `h2_start`,`t`.`h2_count` AS `h2_count`,`t`.`h3_id` AS `h3_id`,`t`.`h3` AS `h3`,`t`.`h3_title_en` AS `h3_title_en`,`t`.`h3_title` AS `h3_title`,`t`.`h3_intro_en` AS `h3_intro_en`,`t`.`h3_intro` AS `h3_intro`,`t`.`h3_start` AS `h3_start`,`t`.`h3_count` AS `h3_count`,`h`.`ordinal` AS `ordinal`,`h`.`numInChapter` AS `numInChapter`,`g`.`id` AS `grade_id`,`g`.`grade_en` AS `grade_grade_en`,`g`.`grade` AS `grade_grade`,`p`.`id` AS `grader_id`,`p`.`shortName_en` AS `grader_shortName_en`,`p`.`shortName` AS `grader_shortName`,`p`.`name_en` AS `grader_name_en`,`p`.`name` AS `grader_name`,`h`.`verified` AS `verified`,`h`.`remark` AS `remark`,`h`.`numActual` AS `numActual`,`h`.`num` AS `num`,`h`.`num0` AS `num0`,`h`.`title_en` AS `title_en`,`h`.`title` AS `title`,`h`.`part_en` AS `part_en`,`h`.`part` AS `part`,`h`.`chain_en` AS `chain_en`,`h`.`body_en` AS `body_en`,`h`.`footnote_en` AS `footnote_en`,`h`.`chain` AS `chain`,`h`.`body` AS `body`,`h`.`footnote` AS `footnote`,`h`.`tags` AS `tags`,`h`.`lastmod` AS `lastmod`,`h`.`highlight` AS `highlight` from (((`hadiths` `h` join `grades` `g`) join `graders` `p`) join `v_toc` `t`) where ((`h`.`gradeId` = `g`.`id`) and (`h`.`graderId` = `p`.`id`) and (`t`.`book_virtual` = 0) and (`h`.`tocId` = `t`.`tId`)) order by `t`.`book_id`,`t`.`h1`,`h`.`numInChapter` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-07-30  0:33:52
