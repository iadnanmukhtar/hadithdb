...
--
-- Table structure for table `hadiths_sim`
--

DROP TABLE IF EXISTS `hadiths_sim`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hadiths_sim` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hadithId1` int NOT NULL,
  `hadithId2` int DEFAULT NULL,
  `ref_num` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ndx_unique` (`hadithId1`,`hadithId2`),
  KEY `ndx_id1` (`hadithId1`),
  KEY `ndx_id2` (`hadithId2`),
  CONSTRAINT `fk_sim_hadith1` FOREIGN KEY (`hadithId1`) REFERENCES `hadiths` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`adnanmukhtar`@`%`*/ /*!50003 TRIGGER `hadiths_sim_BEFORE_INSERT` BEFORE INSERT ON `hadiths_sim` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`adnanmukhtar`@`%`*/ /*!50003 TRIGGER `hadiths_sim_BEFORE_UPDATE` BEFORE UPDATE ON `hadiths_sim` FOR EACH ROW BEGIN
...
-- Dump completed on 2023-07-10 23:55:57
