...
CREATE TABLE `hadiths_virtual` (
  ...
  KEY `ndx_virtual_h1_order` (`bookId`,`h1`,`ordinal`),
  KEY `ndx_virtual_h2_order` (`bookId`,`h1`,`h2`,`ordinal`),
  KEY `ndx_virtual_h3_order` (`bookId`,`h1`,`h2`,`h3`,`ordinal`),
...
-- Dump completed on 2023-07-10 23:56:01
