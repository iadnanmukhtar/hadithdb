...
(async () => {
	var go = false;
	var rows = await global.query(`SELECT id, bookId, num, num0, chain_en, chain, body, text FROM hadiths WHERE bookId>0 ORDER BY bookId, h1, h2, h3, num0`);
