...
const TAFSIRS = {
	...
	'wajiz': {
		...
		description: 'A concise classical tafsir presenting the meanings of the Quran in a direct and accessible form, with brief attention to language, transmitted explanations, and occasions of revelation. It is especially useful for readers seeking al-Wahidi’s distilled interpretation without lengthy scholarly discussion.',
		aqidah: 'Ashari',
		lang: 'ar',
		format: 'md',
	...
	'basit': {
		...
		author_en: 'Ali b. Ahmad al-Wahidi',
		author: 'عَلِيُّ بْنُ أَحْمَدَ الوَاحِدِيّ',
		description: 'Al-Wahidi’s expansive classical tafsir, with extensive attention to Arabic language, poetry, grammar, transmitted reports, and the views of earlier exegetes. It is especially valuable for detailed linguistic analysis and for tracing the scholarly foundations behind his more concise works.',
		aqidah: 'Ashari',
		lang: 'ar',
		format: 'md',
