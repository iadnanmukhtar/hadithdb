...
* Every Mushaf page begins in **Later**, meaning it has not yet been attempted for memorization. Signed-in users can change a page at any time to **Hard**, **Good**, **Easy**, or back to **Later** from the bottom-right controls in Memorize view.
...
* **Later** pages are not included in Review. Returning a page to Later removes it from the active memorization list without discarding its review history.
