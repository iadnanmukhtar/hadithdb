 ...
 * @property {number} [cache.maxAgeDays]
 * @property {number} [cache.maxDiskGB]
 * @property {number} [cache.maxTafsirDiskGB]
 * @property {number} [cache.cleanupIntervalMinutes]
...
global.settings.cache = Object.assign({
	maxAgeDays: 3,
	maxDiskGB: 10,
	maxTafsirDiskGB: 6,
