...
class Hadith {
    ...
    static async a_parseNarrators(hadith) {
        ...
        var chains_en = Arabic.translateChain(hadith.chain).narrators;
        var chains = Arabic.parseNarrators(hadith.chain);
        var inserts = '';
    ...
    static splitHadithText(hadithText) {
        try {
            ...
            var bodyMarked = '';
            textMarked = Arabic.removeDelimeters(Arabic.removeArabicDiacritics(textMarked));

            textMarked = textMarked.replaceAll('صلى الله عليه وسلم', 'ﷺ');
            textMarked = textMarked.replaceAll('صلى الله تعالى عليه وسلم', 'ﷺ');
            textMarked = textMarked.replaceAll('رضي الله عنه(ا|ما|م)?', '');
            ...
            textMarked = textMarked.replace(/(إنه|إن|إنها) /g, '~ ');
