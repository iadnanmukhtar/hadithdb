...
function firstHighlightedFragment(doc, lang) {
	...
	var fields = lang === 'ar'
				? (isQuranAyah
					...
					: ['text', 'footnotes', ...TRANSLATED_COMMENTARY_HIGHLIGHT_FIELDS, 'body', 'body_search_ar', 'sharh', ...TRANSLATED_HADITH_HIGHLIGHT_FIELDS, 'book_name_search_ar', 'book_shortName_search_ar', 'title_search_ar', 'title', 'footnote', 'chain', 'intro_search_ar', 'intro', 'h1_title', 'h2_title', 'h3_title', 'h1_intro', 'h2_intro', 'h3_intro'])
				: (isQuranAyah
