...
function reviewSessionRequest(options) {
  ...
  if (rawMode === 'regular') return { mode: 'regular', reviewUnit: 'ayah', surahNumber: null, pageLimit: null, pageNumber: null };
  if (rawMode === 'page') {
    ...
    return { mode: 'page', reviewUnit: 'ayah', surahNumber: null, pageLimit: null, pageNumber };
  }
  ...
  return { mode: 'surah', reviewUnit, surahNumber: ref.surah, reviewType, pageLimit: reviewType === 'all' ? null : 0, pageNumber: null };
}
    ...
    await q(`
      INSERT INTO ${SESSION_TABLE}
        (session_id,user_uid,scheduled_limit,learning_limit,relearning_limit,weak_limit,memorized_limit,time_budget_minutes,
         session_mode,review_unit,review_surah_number,review_page_limit,review_page_number)
