...
`;
	...
	static scriptAssetVersion() {
		if (!Utils.SCRIPT_ASSET_VERSION) {
			try {
				const script = Buffer.concat(['script.js', 'notebook.js', 'notebook-drive.js', 'account-controls.js'].map(filename => fsSync.readFileSync(path.join(__dirname, '../public/static/js', filename))));
