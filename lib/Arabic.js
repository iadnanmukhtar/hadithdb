...
class Arabic {
	...
	static arabizi2ALALC(s) {
		if (s) {
			s = s.replace(/3([a-zāīūḍḥṣṭẓ])/giu, 'ʿ$1'); // `ayn
			s = s.replace(/([a-zāīūḍḥṣṭẓ])3/gu, '$1ʿ'); // `ayn
	  
			s = s.replace(/2([a-zāīūḍḥṣṭẓ])/gu, 'ʾ$1'); // hamzah
			s = s.replace(/([a-zāīūḍḥṣṭẓ])2/gu, '$1ʾ'); // hamzah
	  
			s = s.replace(/\^6'([a-zāīūḍḥṣṭẓ])/gu, 'Ẓ$1'); // Ẓa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])\^6'/gu, '$1Ẓ'); // Ẓa
			s = s.replace(/6'([a-zāīūḍḥṣṭẓ])/gu, 'ẓ$1'); // ẓa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])6'/gu, 'ẓ1ṭ'); // ẓa
	  
			s = s.replace(/\^6([a-zāīūḍḥṣṭẓ])/gu, 'Ṭ$1'); // Ṭa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])\^6/gu, '$1Ṭ'); // Ṭa
			s = s.replace(/6([a-zāīūḍḥṣṭẓ])/gu, 'ṭ$1'); // ṭa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])6/gu, '$1ṭ'); // ṭa

			s = s.replace(/\^7([a-zāīūḍḥṣṭẓ])/gu, 'Ḥ$1'); // Ṭa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])\^7/gu, '$1Ḥ'); // Ṭa
			s = s.replace(/7([a-zāīūḍḥṣṭẓ])/gu, 'ḥ$1'); // ṭa
			s = s.replace(/([a-zāīūḍḥṣṭẓ])7/gu, '$1ḥ'); // ṭa
	  
			s = s.replace(/\^9'([a-zāīūḍḥṣṭẓ])/gu, 'Ḍ$1'); // Ḍād
			s = s.replace(/([a-zāīūḍḥṣṭẓ])\^9'/gu, '$1Ḍ'); // Ḍād
			s = s.replace(/9'([a-zāīūḍḥṣṭẓ])/gu, 'ḍ$1'); // ḍād
			s = s.replace(/([a-zāīūḍḥṣṭẓ])9'/gu, '$1ḍ'); // ḍād
			
			s = s.replace(/\^9([a-zāīūḍḥṣṭẓ])/gu, 'Ṣ$1'); // Ṣād
			s = s.replace(/([a-zāīūḍḥṣṭẓ])\^9/gu, '$1Ṣ'); // Ṣād
			s = s.replace(/9([a-zāīūḍḥṣṭẓ])/gu, 'ṣ$1'); // ṣād
			s = s.replace(/([a-zāīūḍḥṣṭẓ])9/gu, '$1ṣ'); // ṣād
